...
export const linkList: Section[] = [
        ...
        links: [
            {
                ...
                title: 'Nur mit einer jährlichen Nettozuwanderung von 400.000 Personen bleibt das Arbeitskräfteangebot langfristig konstant',
                description:
            ...
            },
            {
                ...
                title: 'DIW: Deutschland braucht eine nachhaltige und effektive Migrations- und Integrationspolitik',
                description:
    ...
    },
    {
        ...
        links: [
            ...
            {
                url: 'https://www.pik-potsdam.de/de/institut/abteilungen/klimaresilienz/projekte/projektseiten/pikee/unterrichtsmaterialien/klimawissen/klimawissen/zweifel-am-klimawandel/zweifel-am-klimawandel',
                title: 'Faktencheck - Zweifel am Klimawandel',
                description:
                    'Das Potsdam Institut für Klimafolgenforschung hat ein Fact-Checking PDF veröffentlicht, das auf häufig vorgetragene Argumente zu Zweifeln am Klimawandel eingeht.',
            },
        ],
    },
